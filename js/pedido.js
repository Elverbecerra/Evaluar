...
async function fetchProductos() {
	...
	data.forEach((producto, index) => {
		...
		<div class="card mb-4 shadow-sm ">
				<div class="card-header" style="background-color:#005C53">
					<h5 style="font-family:Cursive; color:white;" class="my-0 font-weight-bold">${producto.marca}</h5>
				</div>
				<div class="card-body" style="background-color:">
					<img src=${producto.imagen} class="card-img-top" alt=${producto.marca}>
					<h1 style="color:green" class="card-title pricing-card-title precio">Bs/. <span class="">${
						producto.precio
					}</span></h1>
